...
class shapes_surrealDataset(Dataset):
    """
    ...
    def __init__(self, config):
        Dataset.__init__(self, 'shapes_surreal')
        ...
        self.dataset_name = 'shapes_surreal'
        #self.path = '../../../media/donati/Data1/Datasets/shapes_surreal/'
	self.path = '../../../media/lab601/f2/wxx/GeomFmaps-master/null/shapes_surreal/'
